...
/*
    ...
    to indicate the bulls and B to indicate the cows. In the above example, your function should
    return "1A3B".
...
string getHint(string secret, string guess) {
    vector<int> mp_s(10, 0);
    vector<int> mp_g(10, 0);
    int bulls = 0;
    int cows = 0;
