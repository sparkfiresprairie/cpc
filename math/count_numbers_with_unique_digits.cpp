//
// Created by Xingyuan Wang on 3/22/17.
//
...
/*
    ...
    equals to 10n.
    This problem can also be solved using a dynamic programming approach
    and some knowledge of combinatorics.
    Let f(k) = count of numbers with unique digits with length equals k.
    f(1) = 10, ..., f(k) = 9 * 9 * 8 * ... (9 - k + 2) [The first factor
    is 9 because a number cannot start with 0].
 */
...
// time : O(n) (actually in essense O(1))
// space: O(1)
